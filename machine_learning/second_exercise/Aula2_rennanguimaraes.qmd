---
title: "Atividade 2 - Aprendizado de Máquina"
...
Caso esteja queira acessar o código fonte ou a versão em HTML, .PY ou .QMD,
acesse o [repositório da atividade](https://github.com/rennan-guimaraes/ceds/tree/main/machine_learning/second_exercise) e os arquivos para 
essa atividade serão os nomeados como "Aula2_rennanguimaraes".
...
for feature_name in wine_features.columns:
    ...
    # Estatísticas
    ax2.axis("off")
    stats_text = f"""Média: {wine_features[feature_name].mean():.3f}
...
-   Chat gpt para melhorar eficiencia do código, como por exemplo os loops 
    e retirar dúvidas de entendimento da documentação
-   Links consultados:
